...
Ray AbstractCamera::CaculateRayDirections(int x, int y, Vector2 offset) { return Ray{}; }

Ray PerspectiveCamera::CaculateRayDirections(int x, int y, Vector2 offset)
{
...
Ray EnvironmentCamera::CaculateRayDirections(int x, int y, Vector2 offset)
{
	Vector2 coord = { (offset.x + (Real)x) / m_CameraParameters.width, (offset.y + (Real)y) / m_CameraParameters.height };
