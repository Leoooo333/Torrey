...
int main(int argc, char *argv[]) {
    ...
    if (hw_num == "1_1") {
        ...
        Image3 img = hw_3_7(parameters);
        imwrite("hw_3_7.exr", img);
    }
    else if (hw_num == "3_9") {
        Image3 img = hw_3_9(parameters);
        imwrite("hw_3_9.exr", img);
    }
    else if (hw_num == "3_11") {
        Image3 img = hw_3_11(parameters);
        imwrite("hw_3_11.exr", img);
    } else if (hw_num == "4_1") {
